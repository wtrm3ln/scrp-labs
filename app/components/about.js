...
const About = () => {
  ...
  return (
    <div className={`py-10 transition-colors duration-700 ${
      isInView ? 'bg-dark text-primary' : 'bg-primary text-white'
    }`}>
      <div id="about" className="md:flex max-w-6xl px-5 md:px-0 pt-20 mx-auto justify-between items-start mb-4">
        ...
        <Image src='/mumbai.png' width='150' height='10'/>
        </div>
      </div>
      ...
      <div className='max-w-6xl mt-28 mx-auto text-center'>
        ...
        <div>
          <p className="text-xl font-medium mb-20 max-w-3xl mx-auto">SCRP is a <UnderlineText text={"Run-by-Designers creative kitchen. "} />
